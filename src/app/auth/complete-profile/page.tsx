...
import { Loader2, UserCircle, Music } from 'lucide-react'
    ...
    if (checking) {
        return (
            <MotionDiv
                ...
                initial="initial"
                animate="animate"
                className="min-h-screen flex items-center justify-center bg-gradient-to-br from-background via-sidebar to-background"
            >
